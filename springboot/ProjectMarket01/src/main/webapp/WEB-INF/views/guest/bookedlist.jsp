...
<!-- 				<tr>
			...
			<ul class="pagination justify-content-center">
			    ...
			    <c:choose>
					...
					<c:otherwise>
						<a href="/notice?page=${page.curPage - 1}">Prev</a>
					</c:otherwise>
				</c:choose>
				</li>
			    <!-- 개별 페이지 -->
			    ...
			    <c:forEach var="fEach" begin="${page.startPage}" end="${page.endPage}" step="1">
					...
					<c:otherwise>
						&nbsp;<a href="/notice?page=${fEach}"> ${fEach} </a> &nbsp;
					</c:otherwise>
					</c:choose>
				</c:forEach>
			    </li>
			    ...
			    <c:choose>
					...
					<c:otherwise>
						<a href="/notice?page=${page.curPage + 1}">Next</a>
					</c:otherwise>
				</c:choose>
			    </li>
			    <!-- 끝 -->
			    ...
			    <c:choose>
					...
					<c:otherwise>
						<a href="/notice?page=${page.totalPage}">End</a>
					</c:otherwise>
				</c:choose>
			    </li>
			  </ul>
