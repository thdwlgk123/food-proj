...
public class SingerItem {
    ...
    public SingerItem(String r_name, String gu_name, String t_name, int resId){
        this.r_name=r_name;
    ...
    public SingerItem(String m_number,String r_name, String gu_name, String t_name){
        this.m_number=m_number;
        this.r_name=r_name;
        this.gu_name=gu_name;
        this.t_name=t_name;
    }
    public SingerItem(String m_number,String r_name, String gu_name, String t_name, int countreview, String gradeavg){
        this.m_number=m_number;
        this.r_name=r_name;
        this.gu_name=gu_name;
        this.t_name=t_name;
