...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.RestaurantListItemViewHolder> {
    ...
    private RestaurantListAdapter.ItemClick itemClick;

    public void setItemClick(RestaurantListAdapter.ItemClick itemClick){
    ...
    public class RestaurantListItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public RestaurantListItemViewHolder(View view){
            super(view);
    ...
    @Override
    public RestaurantListAdapter.RestaurantListItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType){
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.restauran_item_view, viewGroup, false);

        RestaurantListAdapter.RestaurantListItemViewHolder viewHolder=new RestaurantListAdapter.RestaurantListItemViewHolder(view);

        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull RestaurantListAdapter.RestaurantListItemViewHolder viewholder, int position){
